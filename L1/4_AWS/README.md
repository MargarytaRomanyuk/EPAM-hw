...
- f. Enter a name for instance and choose `Create instance` ( in my case it was "EPAM-task-WordPress-13"):
...
**Step 7: Configuring a static website using a custom domain registered with Route 53**
